...
#field:whatever.int;kind:integer;count:true;friendly:An Integer;db:whatever.dbint;help:Help for integer;shortcut:1
...
kind | REQUIRED | ip, integer, lotermfield, termfield, uptermfield, lotextfield, textfield, uptextfield (**Note:** see the Valid values for "kind" (data type) table for kind descriptions)
